...
func (r ApiListRoleApplicationsRequest) Execute() ([]ListApplications200ResponseInner, *http.Response, error) {
...
func (a *RolesAPIService) ListRoleApplicationsExecute(r ApiListRoleApplicationsRequest) ([]ListApplications200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (a *RolesAPIService) ListRolesExecute(r ApiListRolesRequest) ([]ListRoles200ResponseInner, *http.Response, error) {
	...
	if r.excludeApplicationId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "excludeApplicationId", r.excludeApplicationId, "")
	}
	if r.type_ != nil {
