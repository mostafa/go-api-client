...
func (r ApiCreateOrganizationScopeRequest) Execute() (*http.Response, error) {
...
func (a *OrganizationScopesAPIService) CreateOrganizationScopeExecute(r ApiCreateOrganizationScopeRequest) (*http.Response, error) {
	...
	if r.createOrganizationScopeRequest == nil {
		return nil, reportError("createOrganizationScopeRequest is required and must be specified")
	}
