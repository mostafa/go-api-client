...
func (a *HooksAPIService) CreateHookExecute(r ApiCreateHookRequest) (*http.Response, error) {
	...
	if r.createHookRequest == nil {
		return nil, reportError("createHookRequest is required and must be specified")
	}
...
func (a *HooksAPIService) GetHookExecute(r ApiGetHookRequest) (*ListHooks200ResponseInner, *http.Response, error) {
	...
	if r.includeExecutionStats != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeExecutionStats", r.includeExecutionStats, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (a *HooksAPIService) ListHookRecentLogsExecute(r ApiListHookRecentLogsRequest) ([]ListHookRecentLogs200ResponseInner, *http.Response, error) {
	...
	if r.logKey != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "logKey", r.logKey, "")
	}
	if r.page != nil {
...
func (r ApiUpdateHookRequest) Execute() (*UpdateHook200Response, *http.Response, error) {
...
func (a *HooksAPIService) UpdateHookExecute(r ApiUpdateHookRequest) (*UpdateHook200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UpdateHook200Response
	)
...
func (r ApiUpdateHookSigningKeyRequest) Execute() (*UpdateHook200Response, *http.Response, error) {
...
// Execute executes the request
//  @return UpdateHook200Response
func (a *HooksAPIService) UpdateHookSigningKeyExecute(r ApiUpdateHookSigningKeyRequest) (*UpdateHook200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
