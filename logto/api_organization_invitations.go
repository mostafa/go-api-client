...
func (r ApiCreateOrganizationInvitationRequest) Execute() (*http.Response, error) {
...
func (a *OrganizationInvitationsAPIService) CreateOrganizationInvitationExecute(r ApiCreateOrganizationInvitationRequest) (*http.Response, error) {
	...
	if r.createOrganizationInvitationRequest == nil {
		return nil, reportError("createOrganizationInvitationRequest is required and must be specified")
	}
...
func (a *OrganizationInvitationsAPIService) ListOrganizationInvitationsExecute(r ApiListOrganizationInvitationsRequest) ([]GetOrganizationInvitation200Response, *http.Response, error) {
	...
	if r.inviterId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "inviterId", r.inviterId, "")
	}
	if r.invitee != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "invitee", r.invitee, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
