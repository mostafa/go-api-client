...
func (o *UpdateSignInExpRequest) GetCustomUiAssetId() string {
	if o == nil || IsNil(o.CustomUiAssetId.Get()) {
		var ret string
		return ret
	}
...
// GetCustomUiAssetIdOk returns a tuple with the CustomUiAssetId field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
func (o *UpdateSignInExpRequest) HasCustomUiAssetId() bool {
	if o != nil && o.CustomUiAssetId.IsSet() {
		return true
	}
