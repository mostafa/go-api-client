...
func (a *ResourcesAPIService) CreateResourceExecute(r ApiCreateResourceRequest) (*http.Response, error) {
	...
	if r.createResourceRequest == nil {
		return nil, reportError("createResourceRequest is required and must be specified")
	}
...
func (r ApiCreateResourceScopeRequest) Execute() (*http.Response, error) {
...
func (a *ResourcesAPIService) CreateResourceScopeExecute(r ApiCreateResourceScopeRequest) (*http.Response, error) {
	...
	if r.createResourceScopeRequest == nil {
		return nil, reportError("createResourceScopeRequest is required and must be specified")
	}
...
func (a *ResourcesAPIService) ListResourcesExecute(r ApiListResourcesRequest) ([]ListResources200ResponseInner, *http.Response, error) {
	...
	if r.includeScopes != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeScopes", r.includeScopes, "")
	}
	if r.page != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "page", r.page, "")
	} else {
