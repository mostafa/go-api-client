...
*ApplicationsAPI* | [**CreateApplicationProtectedAppMetadataCustomDomain**](docs/ApplicationsAPI.md#createapplicationprotectedappmetadatacustomdomain) | **Post** /api/applications/{id}/protected-app-metadata/custom-domains | Add a custom domain to the protected application.
...
*ApplicationsAPI* | [**DeleteApplicationProtectedAppMetadataCustomDomain**](docs/ApplicationsAPI.md#deleteapplicationprotectedappmetadatacustomdomain) | **Delete** /api/applications/{id}/protected-app-metadata/custom-domains/{domain} | Delete a custom domain.
...
*ApplicationsAPI* | [**ListApplicationProtectedAppMetadataCustomDomains**](docs/ApplicationsAPI.md#listapplicationprotectedappmetadatacustomdomains) | **Get** /api/applications/{id}/protected-app-metadata/custom-domains | Get the list of custom domains of the protected application.
