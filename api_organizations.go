...
func (r ApiCreateOrganizationJitEmailDomainRequest) Execute() (*http.Response, error) {
...
func (a *OrganizationsAPIService) CreateOrganizationJitEmailDomainExecute(r ApiCreateOrganizationJitEmailDomainRequest) (*http.Response, error) {
	...
	if r.createOrganizationJitEmailDomainRequest == nil {
		return nil, reportError("createOrganizationJitEmailDomainRequest is required and must be specified")
	}
...
func (a *OrganizationsAPIService) ListOrganizationsExecute(r ApiListOrganizationsRequest) ([]ListOrganizations200ResponseInner, *http.Response, error) {
	...
	if r.showFeatured != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "showFeatured", r.showFeatured, "")
	}
	if r.page != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "page", r.page, "")
	} else {
