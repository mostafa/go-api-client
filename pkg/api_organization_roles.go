...
func (r ApiCreateOrganizationRoleRequest) Execute() (*http.Response, error) {
...
func (a *OrganizationRolesAPIService) CreateOrganizationRoleExecute(r ApiCreateOrganizationRoleRequest) (*http.Response, error) {
	...
	if r.createOrganizationRoleRequest == nil {
		return nil, reportError("createOrganizationRoleRequest is required and must be specified")
	}
