...
func (a *ApplicationsAPIService) ListApplicationsExecute(r ApiListApplicationsRequest) ([]ListApplications200ResponseInner, *http.Response, error) {
	...
	if r.excludeRoleId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "excludeRoleId", r.excludeRoleId, "")
	}
	if r.excludeOrganizationId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "excludeOrganizationId", r.excludeOrganizationId, "")
	}
	if r.isThirdParty != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "isThirdParty", r.isThirdParty, "")
	}
	if r.page != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "page", r.page, "")
	} else {
